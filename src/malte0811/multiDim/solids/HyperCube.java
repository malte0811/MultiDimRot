...
public class HyperCube extends Solid {
	...
	public float[][] colors = { { 0F, 0F, 1F }, { 1F, 0F, 0F }, { 0F, 0F, 1F },
			...
			{ 0F, 0F, 1F }, { 1F, 0F, 0F }, { 0F, 0F, 1F }, { 1F, 0F, 0F },
	...
	public int[][] sides = { { 0, 1, 2 }, { 1, 2, 3 }, { 0, 1, 4 },
			{ 1, 4, 5 }, { 2, 3, 6 }, { 3, 6, 7 }, { 1, 3, 5 }, { 3, 5, 7 },
			{ 0, 2, 4 }, { 2, 4, 6 }, { 4, 5, 6 }, { 5, 6, 7 } };
