...
public class AddonLoader {
	...
	public static void load() throws Exception {
		String base;
		base = System.getProperty("user.dir")+"\\addons\\";
	...
	private static Class<? extends Addon> getJarContent(File zip, URLClassLoader loader) {
		try {
	        ZipFile file = new ZipFile(zip);
	        Enumeration<? extends ZipEntry> e = file.entries();
	        while (e.hasMoreElements()){
	        	System.out.println("Entry in jar: "+e.nextElement().getName());
	        }
	...
	private static void loadEclipseFolder() throws Exception {
		String base = System.getProperty("user.dir")+"\\bin/";
        ...
        URLClassLoader loader = new URLClassLoader(new URL[]{new File(base).toURI().toURL()});
        Class<?> c = loader.loadClass(cont);
        s.close();
